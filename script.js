...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.openBookingForm = function (serviceName) {
        modal.classList.add('active');
        document.body.style.overflow = 'hidden'; // Prevent scrolling

        // Auto-fill service name from the button click
        if (serviceName) {
            ...
            fetch('https://api.web3forms.com/submit', {
                ...
                .then(async (response) => {
                    ...
                    if (response.status == 200) {
                        formMessage.innerHTML = '✅ Booking Request Sent! We will contact you shortly.';
                ...
                .catch(error => {
                    console.log(error);
                    formMessage.innerHTML = '❌ Network error. Please check your connection.';
                    formMessage.className = 'form-message error';
                })
                .finally(() => {
